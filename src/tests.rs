...
fn test_reflect_straight() {
    ...
    assert_eq!(rays::reflect(&ray.dir, &normal), Vector::new(0.0, 0.0, 1.0));
    ...
    let normal = Vector::new(0.0, 0.0, 1.0);
    let ray = rays::Ray { start, dir };
    assert_eq!(rays::reflect(&ray.dir, &normal), Vector::new(1.0, 0.0, 1.0));
    ...
    let ray = rays::Ray { start, dir };
    assert_eq!(rays::reflect(&ray.dir, &normal), Vector::new(1.0, 0.0, 0.0));
}
