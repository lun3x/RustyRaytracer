...
pub fn get_box() -> Scene {
    ...
    // Walls
    let bottom1 = Object::Triangle(Triangle::new(p2, p1, p0, [GREEN; 3], Material::Lambertian));
    let bottom2 = Object::Triangle(Triangle::new(p2, p3, p1, [BLUE; 3], Material::Lambertian));
